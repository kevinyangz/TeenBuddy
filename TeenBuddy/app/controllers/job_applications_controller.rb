class JobApplicationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @job_application.save
        format.html { redirect_to @job_application, notice: 'JobApplication was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @job_application.update(job_application_params)
        format.html { redirect_to @job_application, notice: 'JobApplication was successfully updated.' }
  ...
  private
    ...
    def job_application_params
      params.require(:job_application).permit(:post_id, :teeanger_id)
    end
end
