...
$(document).ready ->
  starTotal = 5
  rate =document.querySelector('.hotel_a .stars-inner').id
  starPercentage = rate/ starTotal * 100
  starPercentageRounded = Math.round(starPercentage / 10) * 10 + '%'
  console.log starPercentageRounded
  document.querySelector(".hotel_a .stars-inner").style.width = starPercentageRounded
# ---
